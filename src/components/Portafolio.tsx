  ...
  return (
    <section className="py-12">
      <div className="max-w-6xl mx-auto px-6">
        <h2 className="text-3xl font-bold text-center mb-8 dark:text-[#61DAFB] text-[#007acc]">Mi Portafolio</h2>
          ...
          {proyectosVisibles.map((proyecto, index) => (
            <div key={index} className="bg-gray-800 rounded-lg shadow-lg p-5 border-l-4 dark:border-[#61DAFB] border-[#007acc] hover:scale-[1.02] transition-transform">
              ...
              <button
                ...
                className="dark:bg-[#61DAFB] bg-[#007acc] text-gray-900 px-4 py-2 rounded-lg font-bold dark:hover:bg-[#4bb3d6] hover:bg-[#007acce5] cursor-pointer"
              >
                📜 Ver más detalle
              </button>
            </div>

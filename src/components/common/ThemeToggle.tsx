...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className={`relative flex h-8 w-[54px] items-center rounded-full border transition-colors duration-300 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-500 focus-visible:ring-offset-2 ${
        isDark

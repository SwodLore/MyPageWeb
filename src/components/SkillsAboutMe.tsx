    ...
    <div className="dark:bg-gray-900 bg-slate-200 p-10 grid md:grid-cols-2">
        <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 py-12 px-6">
                ...
                <div
                    key={index}
                    className="flex flex-col items-center p-3 dark:bg-gray-800 bg-gray-300 rounded-md border dark:border-[#61DAFB] border-[#007acc] dark:text-white text-black text-center"
                >
        ...
        <div className="dark:bg-gray-800 bg-gray-300 p-6 rounded-lg shadow-lg border-l-4 dark:border-[#61DAFB] border-[#007acc]">
            ...
            <div className="p-6 rounded-lg shadow-lg mt-6">
                ...
                <p className="dark:text-white text-black mt-4 text-lg text-center">
